...
function generateBotResponse(userInput) {
  const responses = {
    "hello": "Hello buddy whats your todays query",
    "1": "push-ups:Benefits:(1)Strength and Tone: Push-ups build upper body strength, targeting triceps, pectoral muscles, and shoulders.(2)Cardiovascular Health: They improve circulation and heart health.(3)Convenience: No equipment needed; do them anywhere.(4)Mental Well-Being: Push-ups release endorphins, boosting mood.[Risks and Warnings]:(1)Plateauing: Vary your routine to avoid muscle adaptation.(2)Injury Risk: Incorrect form can cause lower back, wrist, or elbow issues.",
  };
